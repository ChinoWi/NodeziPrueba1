                ...
                <div className="row text-left">
                    ...
                    <div className="medium-10 large-10 columns" >
                        <div style={{paddingLeft:'10px',borderBottom:'2px solid #EDECE8'}}>
                            ...
                            <h6 className="card-item-mostrar question-option" onClick={this.handleClickMostrar}>Mostrar{this.state.showMostrar ? <i className="fa fa-eye showw" aria-hidden="true"></i> : <i className="fa fa-eye-slash hidee" aria-hidden="true"></i>} </h6>
                        </div>
